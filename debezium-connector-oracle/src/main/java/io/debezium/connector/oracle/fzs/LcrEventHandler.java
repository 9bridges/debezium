...
import io.debezium.connector.oracle.fzs.FzsStreamingChangeEventSource.PositionAndScn;
...
class LcrEventHandler {
    ...
    private final FzsStreamingChangeEventSource eventSource;
    ...
    public LcrEventHandler(OracleConnectorConfig connectorConfig, ErrorHandler errorHandler, EventDispatcher<TableId> dispatcher, Clock clock,
                           ...
                           boolean tablenameCaseInsensitive, FzsStreamingChangeEventSource eventSource,
    ...
    private void dispatchDataChangeEvent(RowLCR lcr, Map<String, Object> chunkValues) throws InterruptedException {
        ...
        dispatcher.dispatchDataChangeEvent(
                tableId,
                new FzsChangeRecordEmitter(partition, offsetContext, lcr, oldChunkValues, chunkValues,
