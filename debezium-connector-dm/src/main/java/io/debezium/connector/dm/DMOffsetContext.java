...
public class DMOffsetContext implements OffsetContext {
    ...
    public DMOffsetContext(DMConnectorConfig connectorConfig, Scn scn, Scn commitScn, String lcrPosition,
    ...
    public DMOffsetContext(DMConnectorConfig connectorConfig, Scn scn, String lcrPosition,
                           boolean snapshot, boolean snapshotCompleted, TransactionContext transactionContext) {
    ...
    public static class Builder {
        ...
        private DMConnectorConfig connectorConfig;
        private Scn scn;
        ...
        public Builder logicalName(DMConnectorConfig connectorConfig) {
        ...
        DMOffsetContext build() {
            return new DMOffsetContext(connectorConfig, scn, lcrPosition, snapshot, snapshotCompleted, transactionContext);
        }
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("DMOffsetContext [scn=").append(getScn());
