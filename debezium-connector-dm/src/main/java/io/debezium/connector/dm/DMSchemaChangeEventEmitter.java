...
/**
 * {@link SchemaChangeEventEmitter} implementation based on DM.
 *
 * @author Gunnar Morling
 */
public class DMSchemaChangeEventEmitter implements SchemaChangeEventEmitter {

    private static final Logger LOGGER = LoggerFactory.getLogger(DMSchemaChangeEventEmitter.class);
    ...
    public DMSchemaChangeEventEmitter(DMConnectorConfig connectorConfig, DMOffsetContext offsetContext, TableId tableId,
                                      String sourceDatabaseName, String objectOwner, String ddlText,
                                      DMDatabaseSchema schema, Instant changeTime, DMStreamingChangeEventSourceMetrics streamingMetrics) {
    ...
    public void emitSchemaChangeEvent(Receiver receiver) throws InterruptedException {
        ...
        final DMDdlParser parser = schema.getDdlParser();
