...
/**
 * Parser listener that is parsing DM ALTER TABLE statements
 */
public class AlterTableParserListener extends BaseParserListener {
     ...
     * @param parser DM Antlr parser
     * @param listeners registered listeners
     */
    AlterTableParserListener(final String catalogName, final String schemaName, final DMDdlParser parser,
