...
import io.debezium.connector.dm.BlobChunkList;
...
public final class TransactionalBuffer implements AutoCloseable {
     ...
     */
    TransactionalBuffer(DMConnectorConfig connectorConfig, DMDatabaseSchema schema, Clock clock, ErrorHandler errorHandler,
     ...
     */
    boolean commit(String transactionId, Scn scn, DMOffsetContext offsetContext, Timestamp timestamp,
     ...
     */
    Scn updateOffsetContext(DMOffsetContext offsetContext, EventDispatcher<TableId> dispatcher) throws InterruptedException {
     ...
     */
    void abandonLongTransactions(Scn thresholdScn, DMOffsetContext offsetContext) {
