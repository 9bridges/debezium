...
public interface StreamingAdapter {
    ...
    OffsetContext.Loader<DMOffsetContext> getOffsetContextLoader();

    StreamingChangeEventSource<DMOffsetContext> getSource(DMConnection connection, EventDispatcher<TableId> dispatcher,
     ...
     *
     * By default the DM driver returns table names that are case sensitive.  The table names will
     ...
     */
    default TableNameCaseSensitivity getTableNameCaseSensitivity(DMConnection connection) {
