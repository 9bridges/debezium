...
/**
 * A simple DML parser implementation specifically for DM LogMiner.
 *
 * The syntax of each DML operation is restricted to the format generated by DM LogMiner.  The
...
public class LogMinerDmlParser implements DmlParser {
    ...
    // Use by DM for specific data types that cannot be represented in SQL
    ...
    private Object getColumnUnavailableValue(Object value, Column column) {
        ...
        switch (column.jdbcType()) {
            ...
            case OracleTypes.BLOB:
                return DMValueConverters.UNAVAILABLE_VALUE;
            default:
                return null;
        }
    }
