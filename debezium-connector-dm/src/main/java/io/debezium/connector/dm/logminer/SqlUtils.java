...
/**
 * This utility class contains SQL statements to configure, manage and query DM LogMiner
...
public class SqlUtils {
    ...
    // ****** RAC specifics *****//
    // https://docs.dm.com/cd/B28359_01/server.111/b28319/logminer.htm#i1015913
    // https://asktom.dm.com/pls/asktom/f?p=100:11:0::::P11_QUESTION_ID:18183400346178753
    ...
    public static String allMinableLogsQuery(Scn scn, Duration archiveLogRetention, boolean archiveLogOnlyMode, String archiveDestinationName) {
        ...
        // predicate makes sure that if archive logs are being dually written for other DM services that we
        ...
        //
        // Lastly the query applies "ORDER BY 7" to order the results by SEQ (sequence number). Each DM log
     ...
     * be generated by tools such as DM Data Guard.
     *
     ...
     */
    static String startLogMinerStatement(Scn startScn, Scn endScn, DMConnectorConfig.LogMiningStrategy strategy, boolean isContinuousMining) {
        String miningStrategy;
        if (strategy.equals(DMConnectorConfig.LogMiningStrategy.CATALOG_IN_REDO)) {
    ...
    public static boolean connectionProblem(Throwable e) {
        ...
        return e.getMessage().startsWith("ORA-03135") || // connection lost contact
                ...
                e.getMessage().startsWith("ORA-01089") || // DM immediate shutdown in progress
                e.getMessage().startsWith("ORA-00600") || // DM internal error on the RAC node shutdown could happen
