 ...
 */
package io.debezium.connector.dm.antlr.listener;
...
/**
 * Parser listener that parses column definitions of DM DDL statements.
 */
public class ColumnDefinitionParserListener extends BaseParserListener {

    private final DMDdlParser parser;
    ...
    ColumnDefinitionParserListener(final TableEditor tableEditor, final ColumnEditor columnEditor, DMDdlParser parser,
    ...
    private void resolveColumnDataType(PlSqlParser.DatatypeContext ctx) {
        ...
        if (ctx != null && ctx.native_datatype_element() != null) {
            ...
            // VARCHAR is the same as VARCHAR2 in DM
