...
import io.debezium.connector.dm.logminer.UnistrHelper;
...
public class DMValueConverters extends JdbcValueConverters {
    ...
    private final DMConnection connection;
    ...
    public DMValueConverters(DMConnectorConfig config, DMConnection connection) {
    ...
    public SchemaBuilder schemaBuilder(Column column) {
        ...
        switch (column.jdbcType()) {
            // DM's float is not float as in Java but a NUMERIC without scale
            case Types.FLOAT:
    ...
    protected Object convertString(Column column, Field fieldDefn, Object data) {
        if (data instanceof dm.jdbc.driver.DmdbArray) {
    ...
    protected Object fromDMTimeClasses(Column column, Object data) {
        try {
    ...
    protected Object convertTimestampToEpochMillisAsDate(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochMillisAsDate(column, fieldDefn, fromDMTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampToEpochMicros(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochMicros(column, fieldDefn, fromDMTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampToEpochMillis(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochMillis(column, fieldDefn, fromDMTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampToEpochNanos(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochNanos(column, fieldDefn, fromDMTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampWithZone(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampWithZone(column, fieldDefn, fromDMTimeClasses(column, data));
    }
    ...
    protected Object convertIntervalYearMonth(Column column, Field fieldDefn, Object data) {
        return convertValue(column, fieldDefn, data, NumberConversions.LONG_FALSE, (r) -> {
            if (data instanceof Number) {
                ...
                convertDMIntervalYearMonth(data, r);
            }
            else if (data instanceof String) {
                String value = (String) data;
                // Example: TO_YMINTERVAL('-03-06')
                INTERVALYM interval = new INTERVALYM(value.substring(15, value.length() - 2));
                convertDMIntervalYearMonth(interval, r);
            }
        });
    }

    private void convertDMIntervalYearMonth(Object data, ResultReceiver r) {
    ...
    protected Object convertIntervalDaySecond(Column column, Field fieldDefn, Object data) {
        return convertValue(column, fieldDefn, data, NumberConversions.LONG_FALSE, (r) -> {
            if (data instanceof Number) {
                ...
                convertDMIntervalDaySecond(data, r);
            }
            else if (data instanceof String) {
                String value = (String) data;
                // Exmaple: TO_DSINTERVAL('-001 02:03:04.56')
                INTERVALDS interval = new INTERVALDS(value.substring(15, value.length() - 2));
                convertDMIntervalDaySecond(interval, r);
            }
        });
    }

    private void convertDMIntervalDaySecond(Object data, ResultReceiver r) {
