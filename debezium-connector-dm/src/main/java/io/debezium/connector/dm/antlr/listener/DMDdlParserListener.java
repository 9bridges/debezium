...
/**
 * This class is DM main DDL parser listener class.
 * It instantiates supported listeners, walks listeners through every parsing rule and collects parsing exceptions.
 *
 */
public class DMDdlParserListener extends PlSqlParserBaseListener implements AntlrDdlParserListener {
    ...
    public DMDdlParserListener(final String catalogName, final String schemaName,
                               final DMDdlParser parser) {
