 ...
 */
public class DMErrorHandler extends ErrorHandler {

    public DMErrorHandler(String logicalName, ChangeEventQueue<?> queue) {
        super(DMConnector.class, logicalName, queue);
    }
    ...
    protected boolean isRetriable(Throwable throwable) {
        ...
        return throwable.getMessage().startsWith("ORA-03135") || // connection lost
                ...
                throwable.getMessage().startsWith("ORA-01089") || // DM immediate shutdown in progress
