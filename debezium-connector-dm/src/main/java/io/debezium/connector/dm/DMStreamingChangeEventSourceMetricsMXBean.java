...
/**
 * The JMX exposed interface for DM streaming metrics.
 */
public interface DMStreamingChangeEventSourceMetricsMXBean extends StreamingChangeEventSourceMetricsMXBean {
